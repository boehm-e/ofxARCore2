...
<div style="position: relative; width: 90%;  margin-left:5%; margin-right: 5%;display: flex; justify-content: center; float: left;">
    ...
    <div style="position: absolute; min-width: 100%; display: flex; bottom:0; left: 0;">
    <a href="https://play.google.com/store/apps/details?id=cc.openframeworks.ardrawing"><img src=".img/dl.png" align="left"  width="400"></a>
    </div>
